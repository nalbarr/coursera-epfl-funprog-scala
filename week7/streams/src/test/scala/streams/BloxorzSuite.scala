...
class BloxorzSuite extends FunSuite {
  ...
  // #15
  // NAA.
  // 1. make sure there is additional test for neighbors with history
  ...
  // #15
  // NAA.
  // 1. make sure there is additional test for avoid circle.
  trait AvoidCircles extends Level1 {
